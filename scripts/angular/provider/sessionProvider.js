(function () {
    ...
    angular
            ...
            .service('sessionProvider', sessionProvider);
    
    sessionProvider.$inject = ['localStorageService', 'hotkeys', '$state'];
    
    function sessionProvider(localStorageService, hotkeys, $state) {
